...
//				      url: 'http://localhost:8080/spring-mvc-java/companyResponseBody?callback=getCompanyData',
				      url: 'http://localhost:8084/spring-mvc-java/companyResponseBody?callback=getCompanyData',
				      data: {
				         format: 'json'
				      },
					  type: 'GET',
...
//				      url: 'http://localhost:8080/spring-mvc-java/companyResponseEntity?callback=getCompanyData',
				      url: 'http://localhost:8084/spring-mvc-java/companyResponseEntity?callback=getCompanyData',
				      data: {
				         format: 'json'
				      },
					  type: 'GET',
